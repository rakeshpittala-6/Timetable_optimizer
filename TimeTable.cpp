...
class Scheduler{
    ...
    const int MORNING_SLOT_PENALTY = 2;
    const int LAST_SLOT_PENALTY = 1;
    const int EXTRA_CLASS_PENALTY = 3;
    const int AFTER_LUNCH_PENALTY=24;
public:
    Scheduler(){
    ...
    bool GenerateRandomTimeTable(){
        ...
        //<-------slightly optmised but not produce a random intial table--------->
...
/*
International ITC-2007(track 3):
comp1:
30 courses
=== CV BENCHMARK RESULTS ===
Average Execution Time: 11.2667 ms
Average Penalty Reduction: 57.1922%

comp2:
82 courses
=== CV BENCHMARK RESULTS ===
Average Execution Time: 51.8 ms
Average Penalty Reduction: 62.8034%

comp3:
72 courses
=== CV BENCHMARK RESULTS ===
Average Execution Time: 29.5333 ms
Average Penalty Reduction: 68.6719%

comp16:
108 courses
=== CV BENCHMARK RESULTS ===
Average Execution Time: 41.9 ms
Average Penalty Reduction: 53.6622%

comp20:
121 courses
=== CV BENCHMARK RESULTS ===
Average Execution Time: 45.6 ms
Average Penalty Reduction: 46.1523%

comp21:
94 courses
=== CV BENCHMARK RESULTS ===
Average Execution Time: 39.2 ms
Average Penalty Reduction: 58.8462%
